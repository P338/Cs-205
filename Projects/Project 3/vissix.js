 ...
 */
 $(function() {
   $.getJSON("res/stocks2.json")
    .done(function (data) { visualizeConsumerS(data); })
...
var visualizeConsumerS = function(data){
  var groups = _.groupBy(data, "industry");
  visualize6(groups["ConsumerStaples"]);
};
$('#ConsumerStaples').click(function (e) {
 e.preventDefault()
 $(this).tab('show')
})

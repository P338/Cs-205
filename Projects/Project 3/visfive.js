 ...
 */
 $(function() {
   $.getJSON("res/stocks2.json")
    .done(function (data) { visualizeConsumerDiscretionary(data); })
...
var visualizeConsumerDiscretionary = function(data){
  var groups = _.groupBy(data, "industry");
  visualize5(groups["ConsumerDiscretionary"]);
};
$('#ConsumerDiscretionary').click(function (e) {
 e.preventDefault()
 $(this).tab('show')
})

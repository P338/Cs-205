 ...
 */
 $(function() {
   $.getJSON("res/stocks2.json")
    .done(function (data) { visualizeTele(data); })
...
var visualizeTele = function(data){
  var groups = _.groupBy(data, "industry");
  visualize10(groups["TelecommunicationsServices"]);
};
$('#TelecommunicationsServices').click(function (e) {
 e.preventDefault()
 $(this).tab('show')
})
